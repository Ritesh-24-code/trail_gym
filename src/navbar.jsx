      ...
      <div className="flex items-center justify-between px-8 h-16">
        ...
        <ul className="hidden md:flex items-center gap-8 max-lg:gap-5 list-none">
          ...
          <li>
            <Link
              to="/#Contact"
              className="bg-red-600 text-white text-md font-semibold tracking-wider px-1 lg:text-[0.8rem] md:text-[0.50rem] py-2 rounded hover:bg-white hover:text-red-600 transition-all"
            >
              Join&nbsp;Now
            </Link>
          </li>
...
{/* Mobile menu */}
<ul
  className={`md:hidden absolute left-0 right-0 list-none flex flex-col bg-[#1a1a1a] overflow-hidden transition-all duration-300 ${
...
>
  ...
  >
    <Link
      to="/#Contact"
      className="block font-semibold px-5 py-3 text-white hover:bg-[#222] transition-all"
      onClick={() => setIsOpen(false)}
    >
      Join Now
    </Link>
